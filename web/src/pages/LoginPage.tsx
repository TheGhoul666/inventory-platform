 ...
 * The resulting session is stored by Supabase in localStorage (see supabase.ts)
 * and mirrored into authStore via onAuthStateChange.
 */
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-surface-700 border border-surface-600 rounded-lg px-3 py-2.5 pe-10 text-white placeholder-slate-500 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-colors"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
