...
from app.domain.exceptions import DuplicateResourceError, PermissionDeniedError
...
async def assign_role(
    ...
    svc = AuthService()
    try:
        await svc.assign_role(user_id, body.role, current_user.permissions)
...
async def list_users(
    ...
    svc = AuthService()
    return {"users": await svc.list_users()}
