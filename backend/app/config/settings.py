...
class Settings(BaseSettings):
    ...
    # When unset, the NotificationService falls back to the console/log
    # provider so alerts are always observable in development.
    NOTIFICATIONS_ENABLED: bool = True
    # Notify on every significant inventory change (not just stock alerts)
    NOTIFY_ON_EVERY_CHANGE: bool = True
    # De-dup window (seconds) for repeated stock alerts per item+type
