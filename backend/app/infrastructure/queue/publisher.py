...
class EventPublisher:
    ...
    async def connect(self) -> None:
        # `timeout` bounds the initial TCP/AMQP handshake so an unreachable
        # broker fails fast instead of letting connect_robust retry forever
        # (which would hang application startup). Auto-reconnect still applies
        # AFTER a successful first connection via reconnect_interval.
